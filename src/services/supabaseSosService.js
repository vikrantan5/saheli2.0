// Supabase SOS Service
import * as Location from 'expo-location';
import { Linking, Alert } from 'react-native';
import { TWILIO_CONFIG, TWILIO_SMS_URL } from '../config/twilio';
import { getUserData, getCurrentUser } from './supabaseAuth';
...
// Main SOS activation function (using Supabase)
export const activateSOS = async () => {
  try {
    ...
    // Get user data with emergency contacts from Supabase
    const userDataResult = await getUserData(currentUser.id);
